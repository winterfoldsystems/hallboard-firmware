// Generated from RTT /data/stops. CRS code, name. Do not edit by hand.
#pragma once
...
static const StationRec STATIONS[] = {
  ...
  {"HTN", "Hatton"},
  {"HTO", "Hightown"},
  {"HTR", "Heathrow Airport Bus Station"},
  {"HTW", "Hartwood"},
  {"HTY", "Hattersley"},
  {"HUB", "Hunmanby"},
  {"HUD", "Huddersfield"},
  ...
  {"HWC", "Harwich Town"},
  {"HWD", "Hawarden"},
  {"HWF", "Heathrow Airport Terminal 4 (Bus)"},
  {"HWH", "Haltwhistle"},
  {"HWI", "Horwich Parkway"},
  {"HWM", "Harlow Mill"},
  {"HWN", "Harlow Town"},
  ...
  {"HWW", "How Wood"},
  {"HWX", "Heathrow Airport Terminal 5 (Bus)"},
  {"HWY", "High Wycombe"},
  {"HXM", "Hoveton & Wroxham"},
  ...
  {"XPB", "Bristol International Airport"},
  {"YAE", "Yate"},
  {"YAL", "Yalding"},
  {"YAT", "Yatton"},
  {"YEO", "Yeoford"},
...
static const int STATION_COUNT = 2622;
